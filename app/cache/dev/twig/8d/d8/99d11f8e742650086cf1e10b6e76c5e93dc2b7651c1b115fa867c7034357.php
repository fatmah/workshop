...
class __TwigTemplate_8dd899d11f8e742650086cf1e10b6e76c5e93dc2b7651c1b115fa867c7034357 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["type"]) {
            ...
            echo "    ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->env->getExtension('sonata_core_flashmessage')->getFlashMessages($this->getContext($context, "type"), $this->getContext($context, "domain")));
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 14
                echo "        <div class=\"alert alert-";
                echo twig_escape_filter($this->env, $this->env->getExtension('sonata_core_status')->statusClass($this->getContext($context, "type")), "html", null, true);
                echo "\">
            ";
                // line 15
